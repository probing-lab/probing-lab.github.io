...
| Parameter (gamma): | <input type="number" id="parameter_gamma" name="parameter_gamma" min="0" max="1" step="0.1" value="0.5" onchange="updateParameterGamma(this.value)"> | <input type="range" id="probability_b" name="probability_b" min="0" max="1" step="0.1" value="0.5" onchange="updateProbability_b(this.value)"> |
| Parameter (deltabeta): | <input type="number" id="parameter_deltabeta" name="parameter_deltabeta" min="0" max="1" step="0.1" value="0.5" onchange="updateParameterDeltaBeta(this.value)"> | <input type="range" id="probability_b" name="probability_b" min="0" max="1" step="0.1" value="0.5" onchange="updateProbability_b(this.value)"> |
| Parameter (alphabeta): | <input type="number" id="parameter_alphabeta" name="parameter_alphabeta" min="0" max="1" step="0.1" value="0.5" onchange="updateParameterAlphaBeta(this.value)"> | <input type="range" id="probability_b" name="probability_b" min="0" max="1" step="0.1" value="0.5" onchange="updateProbability_b(this.value)"> |
