...
| --- | --- | --- | --- | --- | --- | --- | --- |
| <input type="text" width="4" id="exact_e_x" name="exact_e_x"> | <input type="text" width="4" id="approx_e_x" name="approx_e_x"> | <input type="text" width="4" id="exact_e_x2" name="exact_e_x2"> |     |  <input type="text" width="4" id="exact_e_x3" name="exact_e_x3">   |     |  <input type="text" width="4" id="exact_e_x4" name="exact_e_x4">    |     |
